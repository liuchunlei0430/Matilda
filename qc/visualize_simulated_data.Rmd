...
This tutorial take CITE-seq for example. We load the simulation results saved in "../output/simulation_result/" folder as input. The output is the umap overlapped data, the umap of real data, and the umap of simulated data for both RNA and ADT. 

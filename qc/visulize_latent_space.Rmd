...
# read simulated data
```{r}
test.sim <- t(fread(glue("../output//dimension_reduction/CITEseq/latent_space.csv")))
test.sim <- test.sim[2:dim(test.sim)[1],]
test.cty.sim <-  t(fread(glue("../output/dimension_reduction/CITEseq/latent_space_label.csv")))[2,]

...
if args.save_simulated_result == True:
    ...
    pd.DataFrame(reconstructed_data.cpu().numpy()).to_csv( '../output/simulation_result/{}/sim.csv'.format(mode))
    pd.DataFrame(real_data.cpu().numpy()).to_csv( '../output/simulation_result/{}/real.csv'.format(mode))
    pd.DataFrame(reconstructed_label.cpu().numpy()).to_csv( '../output/simulation_result/{}/label.csv'.format(mode))
